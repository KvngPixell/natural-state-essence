...
function Admin() {
  ...
  function download() {
    const rows = [
      ["Partner code", "Name", "Pending USD", "Approved unpaid USD", "Paid USD"],
      ...partners.map((p) => {
      ...
      {tab === "partners" && (
        <div className="grid gap-6 lg:grid-cols-[1fr_1.1fr]">
          <div className={panel}>
            ...
            {!partners.length ? (
              <p className="text-sm">
                No partner records yet. Review applications in Inquiries, then add an approved
                partner.
              </p>
            ) : (
              partners.map((p) => (
          ...
          <form
            ...
            onSubmit={(e) => {
              ...
              void run(
                ...
                "Partner saved. Send an invitation to enable a new account.",
              );
            }}
          >
            <h2 className="font-serif text-3xl">
              {selected ? "Edit partner" : "Add approved partner"}
            </h2>
        ...
        <div className="grid gap-6 lg:grid-cols-[.8fr_1.2fr]">
          ...
          >
            ...
            <label className="flex gap-3 text-sm">
              <input type="checkbox" required />I verified payment and partner attribution.
            </label>
            <button disabled={busy} className={button}>
